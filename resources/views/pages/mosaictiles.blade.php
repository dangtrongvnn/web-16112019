...
<div id="breadcrumbs" class="stuck_position"><div class="container">
	<div class="row"><div class="moduletable   col-sm-12"><div class="module_container"><span class="caption">Mosaic Tiles</span>
		<ul class="breadcrumb">
			<li><a href="/index.php" class="pathway">Home</a><span class="divider">&nbsp;/&nbsp;</span></li><li><a href="/index.php/catalog" class="pathway">All Products</a><span class="divider">&nbsp;/&nbsp;</span></li><li><a href="/index.php/catalog/mosaic-tiles" class="pathway">Mosaic Tiles</a><span class="divider">&nbsp;&nbsp;</span></li><li class="active"></li>	</ul>
		</div></div></div>
	</div></div>
			...
			<div class="content-inner">
				...
				<div id="aside-left" class="col-sm-4"><div class="moduletable category"><div class="module_container"><header class='page_header'><h6 class="moduleTitle "><span class="item_title_part_0 item_title_part_odd item_title_part_first_half item_title_part_first item_title_part_last">Categories</span></h6></header><ul class="VMmenu list list__categories list__accordion" id="accordion416">
					<li id="vm-category-76" class="list-item level0 VmClose">
						...
						<li id="vm-category-43" class="list-item level0 parent has-children active">
					...
					<main role="main">
						...
						<div id="bd_results">
							<div id="cf_res_ajax_loader"></div><div id="com_virtuemart">
								<div class="category-view-box"> <h3><span class="item_title_part_0 item_title_part_odd item_title_part_first_half item_title_part_first">Mosaic</span> <span class="item_title_part_1 item_title_part_even item_title_part_second_half item_title_part_last">Tiles</span></h3>
									...
									<div class="browse-view comvirtuemartmod">
										...
										<div class="virtuemart-category__container grid">
											<div id="products-view" class=" products-view " id="products">
												...
												<div class="row prod">
													@foreach($mosaic as $mo)
													<div id="producthorizon343" class="product vm-product-horizon vm-col-3  vertical-separator vm-col span4">
														<div id="producthorizont" class="prod-box spacer product-container">
															...
															<div class="vm-product-media-container">
																<a title="Bianco Arabesque 6mm" href="/index.php/catalog/mosaic-tiles/ceramicmosaic/bianco-arabesque-6mm">
																	<img src="file/images/{{$mo->images}}" alt="Bianco-Arabesque-6mm" class="browseProductImage" />				</a>
																</div>
																<div class="fleft-box">
																...
																<div class="vm-product-descr-container-0">
																	...
																	<div class="product_s_desc">
																		<p><span style="font-size: 12pt;">{{$mo->intro}}										</div>
																		</div>
